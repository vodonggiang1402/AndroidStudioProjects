...
public class SharedPrefs {
    ...
    private SharedPrefs() {
        mSharedPreferences = TMadeApp.self().getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
    }
    ...
    public <T> void put(String key, T data) {
        ...
        if (data instanceof String) {
            ...
            editor.putString(key, TMadeApp.self().getGSon().toJson(data));
        }
        editor.apply();
    }
